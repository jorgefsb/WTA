...
class Fase2_StaticsController extends Core_Controller_ActionDefault
{
    ...
    public function comingsoonAction(){
        ...
        $contentEntity = new Application_Entity_Content();
        $this->view->content = $contentEntity->getByCode("press");
    }
    ...
    public function benefitsAction(){
        ...
        $this->view->headMeta()->appendName('description', 'Forget the race to the bottom of the quality curve, our goal was to create a platform for independent jewelry designers that would allow them to sell their BEST pieces');
